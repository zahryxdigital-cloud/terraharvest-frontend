...
export default function ShopClient({
  ...
  const { items: reduxItems, total: reduxTotal, loading } = useAppSelector((state) => state.product);
  ...
  const items = reduxItems.length > 0 ? reduxItems : initialProducts;
  const total = reduxItems.length > 0 ? reduxTotal : initialTotal;
        ...
        <section className="relative py-14 sm:py-20">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-10">
            ...
            <div
              ...
              id="product-grid"
            >
              {loading && reduxItems.length === 0 && initialProducts.length === 0 ? (
